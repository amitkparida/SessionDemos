...
// Note:
// In case of stack buffer overrun, the hackers/attackers can take control over the Return Address 
...
// (VPTR is most typically located at very beginning of object). Hacker/Attacker can create his own VTABLE, 
// and overwrite the VPTR to point to his VTABLE. See https://defuse.ca/exploiting-cpp-vtables.htm .
