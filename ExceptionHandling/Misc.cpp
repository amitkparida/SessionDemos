...
// Important Notes:
//
// __except(EXCEPTION_EXECUTE_HANDLER) can catch exceptions raised by RaiseException API, e.g. RaiseException(EXCEPTION_CODE, 0, 0, NULL); 
...
int main()
{
    try
    {
        TestMethod();
        //throw 1;
        //RaiseException(1, 0, 0, NULL); // This is also caught by __except()
...
//        //RaiseException(EXCEPTION_INT_DIVIDE_BY_ZERO, 0, 0, NULL); // This is also caught by __except()
//        //TestMethod();
//    }
